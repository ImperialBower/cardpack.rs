...
pub use crate::funky::decks::basic::Deck;
pub use crate::funky::decks::basic::card::*;
pub use crate::funky::decks::joker::Joker;
...
pub use crate::funky::decks::voucher::Voucher;
pub use crate::funky::decks::voucher::card::*;
